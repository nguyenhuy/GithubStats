...
+ (NSString *)appendParams:(NSDictionary *)params toPath:(NSString *)path;
...
+ (NSString *)appendParams:(NSDictionary *)params toPath:(NSString *)path {
    ...
    return [NSString stringWithFormat:@"%@%@", path, mutablePath];
}
...
- (id)sendRequest:(NSString *)path requestType:(UAGithubRequestType)requestType responseType:(UAGithubResponseType)responseType withParameters:(id)params page:(NSInteger)page error:(NSError * __strong *)error
{
	...
	{
        querystring = [NSMutableString stringWithString:[UAGithubEngine appendParams:params toPath:@""]];
	}
...
- (void)pullRequestsForRepository:(NSString *)repositoryPath withParameters:(NSDictionary *)params success:(UAGithubEngineSuccessBlock)successBlock failure:(UAGithubEngineFailureBlock)failureBlock
{
    NSString *path = [UAGithubEngine appendParams:params toPath:[NSString stringWithFormat:@"repos/%@/pulls", repositoryPath]];
    [self invoke:^(id self){[self sendRequest:path requestType:UAGithubPullRequestsRequest responseType:UAGithubPullRequestsResponse error:nil];} success:successBlock failure:failureBlock];
}
...
{
    NSString *path = [UAGithubEngine appendParams:params toPath:[NSString stringWithFormat:@"repos/%@/commits", repositoryPath]];
